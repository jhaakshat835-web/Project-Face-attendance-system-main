...
import dj_database_url  # IMPORT ADDED: Required for Render Database
...
DATABASES = {
    'default': dj_database_url.config(
        # If running on Render, use the PostgreSQL DATABASE_URL.
        # If running locally, fall back to the SQLite file.
